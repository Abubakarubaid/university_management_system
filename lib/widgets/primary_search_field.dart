...
class PrimarySearchFiled extends StatelessWidget {
  TextEditingController controller;
  String hint;
  var keyboardType;
  Function(String) onChange;

  PrimarySearchFiled({required this.controller, required this.hint, required this.keyboardType, required this.onChange, Key? key}) : super(key: key);
