class UserModelAttendance {
  ...
  UserModelAttendance.getInstance();
  ...
  UserModelAttendance.fromJson(Map<String, dynamic> map){
    userId = map["userId"];
    ...
    overAllAttendancePercentage = map["overAllAttendancePercentage"];
  }
}