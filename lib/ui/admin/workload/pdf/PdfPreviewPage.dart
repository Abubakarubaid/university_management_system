...
import 'package:university_management_system/ui/admin/workload/pdf/pdfexport.dart';
...
class PdfPreviewPage extends StatelessWidget {
  ...
  PdfPreviewPage({required this.workloadList, required this.teachersList, Key? key}) : super(key: key);
          ...
          child: Stack(
            children: [
              ...
              PdfPreview(
                ...
                build: (context) => makePdf(workloadList, teachersList),
              ),
              Container(
