...
class AttendanceWorkload extends StatefulWidget {
  DepartmentModel departmentModel;
  AttendanceWorkload({required this.departmentModel, Key? key}) : super(key: key);

  @override
  State<AttendanceWorkload> createState() => _AttendanceWorkloadState();
}

class _AttendanceWorkloadState extends State<AttendanceWorkload> {
          ...
          child: Stack(children: [
                  ...
                  Expanded(
                    ...
                    ListView.builder(
                      ...
                      itemBuilder: (context, index) =>
                          GestureDetector(
                            onTap: () {
                              Navigator.of(context).push(MaterialPageRoute(builder: (context) => FetchAllAttendance(workloadModel: appProvider.workloadList[index],)));
                            },
                            child: Container(
                    ...
                    ListView.builder(
                      ...
                      itemBuilder: (context, index) =>
                          GestureDetector(
                            onTap: () {
                              Navigator.of(context).push(MaterialPageRoute(builder: (context) => FetchAllAttendance(workloadModel: searchList[index],)));
                            },
                            child: Container(
                              clipBehavior: Clip.antiAlias,
                                      ...
                                      child: Column(mainAxisAlignment: MainAxisAlignment.start, children: [
                                        ...
                                        Expanded(
                                          child: Row(crossAxisAlignment: CrossAxisAlignment.start,children: [
                                            const Icon(Icons.subject, color: AppAssets.textLightColor,),
                                            const SizedBox(width: 8,),
                                            Expanded(child: Text(searchList[index].departmentModel.departmentName, style: AppAssets.latoRegular_textDarkColor_14, maxLines: 2, overflow: TextOverflow.ellipsis,)),
                                            const SizedBox(width: 6,),
                                          ],),
                                        ),
                                      ],),
            ...
            Container(
              ...
              child: Row(children: [
                ...
                Expanded(child: Container(padding: const EdgeInsets.only(left: 20, right: 20), child: Center(child: Text("All Attendances", style: AppAssets.latoBold_textDarkColor_20)))),
