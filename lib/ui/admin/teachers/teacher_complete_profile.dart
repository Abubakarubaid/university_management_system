...
class TeacherCompleteProfile extends StatefulWidget {
  TeacherModel teacherModel;
  TeacherCompleteProfile({required this.teacherModel, Key? key}) : super(key: key);

  @override
  State<TeacherCompleteProfile> createState() => _TeacherCompleteProfileState();
}

class _TeacherCompleteProfileState extends State<TeacherCompleteProfile> {
    ...
    return Scaffold(
      body: SafeArea(
        child: Consumer<AppProvider>(builder: (context, appProvider, child) {
          if(Provider.of<AppProvider>(context, listen: false).teacherUpdatedModel.userModel.userId != 0) {
                ...
                children: [
                  Stack(children: [
                    Container(
                      ...
                      child: Container(
                        ...
                        child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,children: [
                          ...
                          GestureDetector(
                            onTap: () {
                              Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context) => TeacherProfileEdit(teacherModel: teacherModel,),));
                            },
                            child: Container(
                    ...
                    Align(
                      ...
                      child: Container(
                        ...
                        child: teacherModel.userModel.userImage.isEmpty || teacherModel.userModel.userImage == "null" ? SvgPicture.asset(teacherModel.userModel.userGender == "male" ? AppAssets.maleAvatar : AppAssets.femaleAvatar, color: AppAssets.textDarkColor,) : Image.network(IPConfigurations.serverImagePath+teacherModel.userModel.userImage, fit: BoxFit.cover,),
                      ),
                    ),
                  ]),
                  Container(
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Text("Total Allowed Credit Hours", style: AppAssets.latoBlack_textLightColor_12,),
                        const SizedBox(width: 4,),
                        Text(teacherModel.userModel.totalAllowedCreditHours.toString(), style: AppAssets.latoRegular_textDarkColor_16, maxLines: 1, overflow: TextOverflow.ellipsis,),
                      ],),
                  ),
                  Container(
                    width: double.infinity,
