...
import 'TeacherPdfExport.dart';

class TeacherPdfPreviewPage extends StatelessWidget {
  TeacherModel teacherModel;
  TeacherPdfPreviewPage({required this.teacherModel, Key? key}) : super(key: key);
          ...
          child: Stack(
            children: [
              ...
              PdfPreview(
                ...
                build: (context) => individualMakePdf(teacherModel),
              ),
              Container(
