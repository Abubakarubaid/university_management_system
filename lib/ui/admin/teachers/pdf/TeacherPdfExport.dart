          ...
          for(int j=0; j<teacherModel.workloadList.length; j++)
            if(teacherModel.workloadList[j].workDemanded != "Demanded")
              TableRow(children: [
                ...
                Expanded(flex: 4, child: Padding(padding: const EdgeInsets.symmetric(vertical: 2, horizontal: 3), child: Align( alignment: Alignment.center, child: Text(teacherModel.workloadList[j].departmentModel.departmentName, style: TextStyle(fontSize: 7, fontWeight: FontWeight.normal), textAlign: TextAlign.center),),),),
              ]),
