...
class _SignUpPageState extends State<SignUpPage> {
  ...
  Future<void> _handleSaveButtonPressed() async {
    ...
    print("_____________________: ${imageData}");
  }
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Align(
                          ...
                          child: Text("Registration",style: AppAssets.latoBold_primaryColor_30,)),
                    ),
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: PrimaryTextFiled(controller: emailController,onChange: (value){},hint: "Enter Email Address",keyboardType: TextInputType.emailAddress,
                          ),
                        ),
                        SizedBox(height: 20,),
                        Container(
                        ...
                        Container(
                          margin: EdgeInsets.only(left: 20,right: 20),
                          child: PrimaryTextFiled(controller: confirmPasswordController,onChange: (value){},hint: "Enter Confirm Password",keyboardType: TextInputType.text,),
                        ),
                        SizedBox(height: 20,),
                        Container(
                          margin: EdgeInsets.only(left: 22),
