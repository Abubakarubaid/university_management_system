            ...
            children: [
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        SizedBox(width: 16,),
                        Expanded(child: Text("Your Profile", style: AppAssets.latoBold_textDarkColor_16, maxLines: 1, overflow: TextOverflow.ellipsis,)),
                      ],
                    ),
                  ),
                ),
                    ...
                    builder: (context) => StatefulBuilder(builder: (context, setState) =>AlertDialog(
                      ...
                      content: Column(mainAxisSize: MainAxisSize.min,children: [
                        ...
                        Container(
                          ...
                          child: Align(alignment: Alignment.centerLeft, child: Text("${appName}",textAlign: TextAlign.center, style: AppAssets.latoBold_textDarkColor_16,)),
                        ),
                        Container(
                          margin: EdgeInsets.only(top: 12),
                    ...
                    builder: (context) => AlertDialog(
                      ...
                      content: Column(mainAxisSize: MainAxisSize.min,children: [
                        ...
                        Container(
                          ...
                          child: Align(alignment: Alignment.centerLeft, child: Text("03058008620",textAlign: TextAlign.center, style: TextStyle(fontSize: 13, color: Color(0xFF333333).withOpacity(0.5),),)),
                        ),
                        Container(
                          margin: EdgeInsets.only(top: 12),
                        ...
                        Container(
                          ...
                          child: Align(alignment: Alignment.centerLeft, child: Text("dummy@gmail.com",textAlign: TextAlign.center, style: TextStyle(fontSize: 13, color: Color(0xFF333333).withOpacity(0.5),),)),
                        ),
                        Container(
                          margin: EdgeInsets.only(top: 12),
                        ...
                        Container(
                          ...
                          child: Align(alignment: Alignment.centerLeft, child: Text("Lahore",textAlign: TextAlign.center, style: TextStyle(fontSize: 13, color: Color(0xFF333333).withOpacity(0.5),),)),
                        ),
                        InkWell(
                          onTap: () {
                            Navigator.of(context).pop();
              ...
              Expanded(
                child: Container(
                  ...
                  child: SvgPicture.asset(AppAssets.approveIcon, color: Colors.black.withOpacity(0.05),),
                ),
              ),
              Container(
                width: double.infinity,
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text("Dr. Hassan Ubaid", style: TextStyle(color: Colors.black.withOpacity(0.3), fontSize: 14),),
                  ],
                ),
              ),
            ],
